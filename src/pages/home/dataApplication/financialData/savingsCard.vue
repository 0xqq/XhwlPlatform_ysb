<template>
    <div class="StopintheCharge">
                ...
                <div class="date-device">
                    <div>
                        <el-input placeholder="请输入搜索内容" v-model="input5" class="place">
                            <el-select v-model="select" slot="prepend" placeholder="卡号" class="place">
        ...
        <el-table :data="tableData3" height="250" border style="width: 100%" id="tableExcel">
            ...
            <el-table-column prop="province" label="储值金额">
            </el-table-column>
            <el-table-column prop="province" label="储值时间">
            </el-table-column>
        </el-table>
        <div class="pager">
            <div class="block">
...
.StopintheCharge {
    .device_nav {
        ...
        background-size: 100% 100%; //导航栏右边的日历搜索等框
        .img-time {
            display: inline-block;
            height: 0.6rem;
            width: auto;
