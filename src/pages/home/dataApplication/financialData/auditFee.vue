<template>
    <div class="StopintheCharge">
        ...
        <div class="device_nav">
            <div class="img-time">
                <div class="into-time">
                    <el-select v-model="value" placeholder="缴费时间">
        ...
        <el-table :data="tableData3" height="250" border style="width: 100%" id="tableExcel">
            ...
            <el-table-column prop="date" label="应收金额">
            </el-table-column>
            <el-table-column prop="province" label="实收金额">
            </el-table-column>
            <el-table-column prop="name" label="到期时间">
            </el-table-column>
            <el-table-column prop="date" label="欠费金额">
            </el-table-column>
            <el-table-column prop="province" label="缴费金额">
            </el-table-column>
            <el-table-column prop="province" label="缴费时间">
            </el-table-column>
        </el-table>
        <div class="pager">
            <div class="block">
