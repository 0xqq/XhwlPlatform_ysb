    ...
    <div class="StopintheCharge">
        ...
        <div class="device_nav">
                ...
                <div class="date-device">
                    <div>
                        <el-input placeholder="请输入搜索内容" v-model="input5" class="place">
                            <el-select v-model="select" slot="prepend" placeholder="报销人" class="place">
                                <el-option label="报销人" value="1"></el-option>
                                <el-option label="发票编号" value="1"></el-option>
          ...
          <el-table :data="tableData3" height="250" border style="width: 100%" id="tableExcel">
            <el-table-column prop="name" label="报销时间">
            </el-table-column>
            <el-table-column prop="date" label="报销人">
            </el-table-column>
            <el-table-column prop="province" label="报销事项">
            </el-table-column>
             <el-table-column prop="province" label="金额">
            </el-table-column>
             <el-table-column prop="province" label="发票编号">
            </el-table-column>
             <el-table-column prop="province" label="报销事项">
            </el-table-column>
...
export default {
    data() {
        return {
            abc: ['数据应用', '财务数据', '出支收纳查询', "费用报销支出"],
           currentPage2: 5,
            massageData: ['欠费业主姓名', '到期时间', '欠费金额'],
            tableData3: [{
                date: '2016-05-03',
                name: '王小虎',
                province: '上海',
