<template>
    <div class="StopintheCharge">
                ...
                <div class="date-device">
                    <div>
                        <el-input placeholder="请输入搜索内容" v-model="input5" class="place">
                            <el-select v-model="select" slot="prepend" placeholder="领用人" class="place">
                                <el-option label="领用人" value="1"></el-option>
        ...
        <el-table :data="tableData3" height="250" border style="width: 100%" id="tableExcel">
            <el-table-column prop="name" label="领用时间">
            </el-table-column>
            ...
            <el-table-column prop="province" label="用途">
             ...
             <el-table-column prop="province" label="归还时间">
            </el-table-column>      
        </el-table>
        <div class="pager">
            <div class="block">
