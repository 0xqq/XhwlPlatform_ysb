<template>
	<div class="parkOut">
		...
		<div class="top_div">
				<span class="title">停车场出入行为数据</span>
				<div class="top_right">
			...
			<table cellpadding="0" cellspacing="0"  id="tableExcel">
				<thead>
					<tr class="nav_table">
						...
						<th>停车场入场流量(次)</th>
						<th>停车场出场流量(次)</th>
						<th class="left_2">场内车数量(辆)</th>
						<th class="left_2">软件放行(次)</th>
						<th class="left_2">软件放行占比</th>
						<th>收费已满放行(次)</th>
						<th>收费已满放行占比</th>
						<th>免费时间段放行(次)</th>
						<th>免费时间段放行占比</th>
						<th class="left_2">月卡车放行(次)</th>
						<th class="left_2">月卡车放行占比</th>
						<th>手动开闸放行(次)</th>
						<th>手动开闸放行占比</th>
					</tr>
				</thead>
...
export default {
	data() {
		return {
			abcd: ['数据应用', '安防数据', '行为数据数据分析', '停车出入行为数据'],
			model: 'chart',
			width:'99.8%',
			inputValue: null,
			showSelf: 0,
			...
			Series2: [{
	         ...
	         //图表3数据------------------------------------------------------------------------------------------------------
	        threeText:"车辆放行方式分析",
			threeLegend:['软件放行','收费已满放行','免费时间段放行'],
			unit3:"次",
			Series3:[{name:'软件放行',
		            type:'bar',
		            stack: '总量',
		    ...
		    //图表4数据-------------------------------------------------------------------------------------------------------
			fourText:"车辆放行方式分析",
			fourLegend:['邮件营销','联盟广告','视频广告','直接访问','搜索引擎'],
			Series4:[{
	            name:'邮件营销',
	            type:'line',
	            stack: '总量',
