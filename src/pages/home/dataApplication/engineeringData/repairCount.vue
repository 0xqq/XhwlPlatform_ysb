...
<div class="attendanceData">
  ...
  <div class="Chart_div">
    ...
    <echarts-four1 :class="{hide: showSelf==1,chart2: showSelf=='0'}" :Text='twoText' :Xvalue="Xvalue" :Legend="twoLegend" :Series="Series2" :Unit1="unit_l" :Unit2="unit_r">
    </echarts-four1>
  ...
  data() {
    return {
      ...
      Series2: [{
        ...
        data: [2.0, 4.9, 7.0, 23.2, 25.6, 76.7, 86.6, 62.2, 32.6, 20.0, 6.4, 3.3, 2.0, 4.9, 7.0, 23.2, 25.6, 76.7, 86.6, 62.2, 32.6, 20.0, 6.4, 3.3, 2.0, 4.9, 7.0, 23.2, 25.6, 76.7, 86.6, 62.2, 32.6, 20.0, 6.4, 3.3, 2.0, 4.9, 7.0, 23.2, 25.6,
          76.7, 86.6, 62.2, 32.6, 20.0, 6.4, 3.3, 2.0, 4.9, 7.0, 23.2, 25.6, 76.7
        ]
      }, {
        name: '利润',
        type: 'line',
        yAxisIndex: 1,
        data: [2.6, 5.9, 9.0, 26.4, 28.7, 70.7, 175.6, 182.2, 48.7, 18.8, 6.0, 2.3, 2.6, 5.9, 9.0, 26.4, 28.7, 70.7, 175.6, 182.2, 48.7, 18.8, 6.0, 2.3, 2.6, 5.9, 9.0, 26.4, 28.7, 70.7, 175.6, 182.2, 48.7, 18.8, 6.0, 2.3, 2.6, 5.9, 9.0, 26.4,
          28.7, 70.7, 175.6, 182.2, 48.7, 18.8, 6.0, 2.3, 175.6, 182.2, 48.7, 18.8, 48.7, 18.8
        ]
      }, {
        name: '成本',
        type: 'line',
        yAxisIndex: 1,
        data: [2.0, 2.2, 3.3, 4.5, 6.3, 10.2, 20.3, 23.4, 23.0, 16.5, 12.0, 6.2, 2.0, 2.2, 3.3, 4.5, 6.3, 10.2, 20.3, 23.4, 23.0, 16.5, 12.0, 6.2, 2.0, 2.2, 3.3, 4.5, 6.3, 10.2, 20.3, 23.4, 23.0, 16.5, 12.0, 6.2, 2.0, 2.2, 3.3, 4.5, 6.3, 10.2,
          20.3, 23.4, 23.0, 16.5, 12.0, 6.2, 20.3, 23.4, 23.0, 16.5, 6.2, 20.3,
        ]
      }],
      conTents: [{
          "plate": "2017-8-01",
