...
export default {
	...
	methods: {
		modifu(d) {
			this.modifyvue = d;
			this.$router.push({ path: '/config/projectcfg/resource/new', query: { value: this.modifyvue } });
		},
		removeTode(keep) {
			// console.log(keep);
