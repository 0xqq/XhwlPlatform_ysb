	...
	<div class="device">
		...
		<div class="device-nav">
			<div class="img-time">
				...
				<div class="date-time">
					<div class="block">
						<el-date-picker type="datetimerange" placeholder="选择时间范围" class="el_picker">
						</el-date-picker>
					</div>
				</div>
					...
					<tr class="nav_table">
						...
						<th class="left_none">
							<select>
								...
								<option value="audi">日常工作车辆</option>
								<option value="saabs">事务性车辆</option>
								<option value="opel">特权车辆</option>
