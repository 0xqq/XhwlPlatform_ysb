...
import secureEnvironmentObj from '@/httpData/C_secureEnvironment_2.js'
import {
  mapState
} from 'vuex'
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      var cityName1 = value.停车位总数前十;
      var cityName2 = value.车辆入场流量前十;
      var cityName3 = value.剩余车位数前十;
      var cityName4 = value.车位利用率前十;
      var cityName5 = value.车位周转率前十;
      var cityName6 = value.异常抬杆率前十;
