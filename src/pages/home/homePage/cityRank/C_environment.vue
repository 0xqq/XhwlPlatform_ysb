<template>
	<div class="Odiv">
		...
		<p class="title">{{this.yearNow}}年{{this.monthNow}}月中海物业集团深圳市环境数据分析</p>
		<!--数据显示-->
		<div class="data_div">
...
import Mapvue from '@/components/city_May/C_environmentMap'
import timeSelect from '@/components/common/timeSelect'
import Homenav from '@/components/common/cityHomeNav'
import environmentObj from '@/httpData/C_environment.js'
import {
  mapState
} from 'vuex';
export default {
  data() {
    return {
      ...
      yearNow: '2017',
      monthNow: '9',
      title: ['环境工作完率', '生活水质指数', '泳池水质指数', '景观水质指数', '空气质量评指数'],
      data: ['98%', '98', '99', '97', '95'],
      data1: '',
      data2: '',
      data3: '',
  ...
  methods: {
    ...
    getData() {
      this.content = environmentObj.content
