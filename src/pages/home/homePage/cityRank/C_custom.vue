...
<div class="Odiv">
  ...
  <p class="title">{{this.yearNow}}年{{this.monthNow}}月中海物业集团深圳市客服数据分析</p>
  <div class="data_div">
...
import Mapvue from '@/components/city_May/C_customMap'
import timeSelect from '@/components/common/timeSelect'
import Homenav from '@/components/common/cityHomeNav'
import customObj from '@/httpData/C_custom.js'
import {
  mapState
} from 'vuex'
export default {
  ...
  methods: {
    ...
    //获取数据
    getData() {
      this.content = customObj.content
