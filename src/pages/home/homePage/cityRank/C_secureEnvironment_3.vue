...
//	    timeSelect
  ...
  methods: {
	...
	getData(){
		 	this.$http({
				url:this.mnUrl+"/tmp/safe/city_door_in_out",
				method:'get',
			}).then(function(res){
			    if(res.body.status){
					...
					var cityName1 = res.body.content[0].业主入流浪前十;
					var cityName2 = res.body.content[0].访客入场流量前十;
					var cityName3 = res.body.content[0].滞留人员数前十;
					var cityName4 = res.body.content[0].异常开门率前十;
