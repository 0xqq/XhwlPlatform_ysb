...
export default {
    ...
    methods: {
    	getYear(year){
	  	...
	  	getData(){
		 	this.$http({
			    ...
			    this.Data=res.body.finance.carData;			    
			    this.cityName1=res.body.finance.car.should.cityName;
			    this.cityData1=res.body.finance.car.should.data;
			    this.cityName2=res.body.finance.car.reality.cityName;
			    this.cityData2=res.body.finance.car.reality.data;
			    this.cityName3=res.body.finance.car.scale.cityName;
			    this.cityData3=res.body.finance.car.scale.data;
			    if(this.isFirst){
			    	//第一次获取数据进行实列化
		...
		Property(){		
		this.$router.push({path:'M_financialDataProperty'});		
  		},
		drawLine() {
			var  refThis = this;
