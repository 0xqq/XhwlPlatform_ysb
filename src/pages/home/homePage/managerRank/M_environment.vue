<template>
	<div class="Odiv">
		...
		<p class="title">{{year}}中海物业集团广州分公司环境数据分析</p>
		<!--数据显示-->
		<div class="data_div">
...
import Mapvue from '@/components/manager_Map/M_environmentMap'
...
export default {
  data () {
	    return {
			...
			cityData1:[100, 82, 70, 64, 50, 40, 30,20,10],
  	...
  	methods: {
		...
		drawLine() {
			...
			myChart1.on('click', function (params) {
			 	...
			 	refThis.$router.push({path:"C_environment"});			 	
			        });
