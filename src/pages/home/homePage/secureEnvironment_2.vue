	    ...
	    getData(){
	    	this.loading(true);
		 	this.$http({
				...
				var value = res.body.content.停车场总数据;
				...
				var cityName1 = res.body.content.停车场总数前十;
				var cityName2 = res.body.content.车辆入场数前十;
				var cityName3 = res.body.content.剩余车位数前十;
				var cityName4 = res.body.content.车位利用率前十;
				var cityName5 = res.body.content.车位周转率前十;
				var cityName6 = res.body.content.异常抬杆率前十;
