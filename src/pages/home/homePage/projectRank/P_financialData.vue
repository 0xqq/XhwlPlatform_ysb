...
import financeObj from '@/httpData/P_financialData.js'
export default {
  data() {
    return {
      title_tu: '备用金',
  ...
  methods: {
    ...
    getData() {
      var value = financeObj.content
      this.data1 = value['收费应收总金额'];
      this.data2 = value['收费实收总金额'];
      this.data3 = value['应收实收差额'];
      this.data4 = value['支出总金额'];
      if (this.isFirst) {
        //第一次获取数据进行实列化
