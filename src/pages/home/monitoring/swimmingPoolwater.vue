...
//		},
        ...
        getData(){
				const url = this.mnUrl + "/tmp/watching/map/index"
				this.$http.get(url).then(res => {
					//console.log(res.body.content);
					this.inOut = res.body.content.出入.东门;
					//console.log(this.inOut)
					this.vedio= res.body.content.视频,
		            this.watch= res.body.content.巡更,
		            this.equipment= res.body.content.设备,
		            this.elevator= res.body.content.电梯,
		            this.all= res.body.content.全部
				},(err)=>{
					console.log(err);
				})
			}
