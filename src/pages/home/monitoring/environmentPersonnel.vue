...
export default {
    data() {
        return {
            ...
            point:[
                {"x":"114.059323","y":"22.539379"},
                {"x":"114.059217","y":"22.538907"},
                {"x":"114.05878","y":"22.539215"},
                {"x":"114.05878","y":"22.538805"},
                {"x":"114.05828","y":"22.538805"},
                {"x":"114.05856","y":"22.539445"},
                {"x":"114.058086","y":"22.539532"},
                {"x":"114.057751","y":"22.53922"},
                {"x":"114.057751","y":"22.53862"}
            ]
        }
    },
    computed: {
    ...
    methods: {
        initMap(){
            ...
            // // 初始化地图,设置中心点坐标和地图级别
            // map.centerAndZoom(new BMap.Point(114.058567,22.538966), 20);
            // // 添加地图类型控件
        ...
        createIcon(){
            ...
            for(var i=0; i<=this.point.length-1; i++){
                ...
                var marker = new BMap.Marker(new BMap.Point(this.point[i].x,this.point[i].y), {icon: myIcon});
        ...
        drawLine(){
			...
			var interval=setInterval(function(){
                ...
                var polyline = new BMap.Polyline([pointlh,pointls],{strokeColor:"blue",strokeWeight:3,strokeOpacity:1});
...
<style lang="scss" scoped>
    ...
    .content {
        width: 13.65rem;
        height: 8.04rem; // background:skyblue;
        margin: 0 auto;
