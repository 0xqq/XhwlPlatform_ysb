    ...
    drawLine() {
      ...
      var option2 = {
        ...
        series: [{
            ...
            itemStyle: {},
            data: [{
                value: 100 - this.month_card,
                name: '未缴费率'
              },
              {
                value: this.month_card,
                name: '月卡缴费率',
                itemStyle: pointOut
              },
            ]
          },
          {
            ...
            data: [{
                value: 100 - this.satisfied,
                name: '不满意',
                itemStyle: color2
              },
              {
                value: this.satisfied,
                name: '报事销项率',
                itemStyle: color1
              },
            ]
      ...
      var option6 = {
        ...
        series: [{
          ...
          },
          {
            ...
            data: [{
                name: 'other',
                value: 100 - this.turn_out_for_work,
                itemStyle: labelB
              },
              {
                name: '出勤率',
                value: this.turn_out_for_work,
                itemStyle: labelT
              }
            ]
          }
