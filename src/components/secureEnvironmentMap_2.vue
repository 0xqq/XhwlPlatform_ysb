...
export default {
  ...
  methods: {
    getData() {
      ...
      var data1 = this.content.停车场总数前十;
      var data2 = this.content.车辆入场数前十;
      var data3 = this.content.剩余车位数前十;
      var data4 = this.content.车位利用率前十;
      var data5 = this.content.车位周转率前十;
      var data6 = this.content.异常抬杆率前十;
