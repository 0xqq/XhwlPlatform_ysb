...
import financialMapObj from '@/httpData/financialMap.js';
...
export default {
      ...
      for (var i = 0; i < this.content.length; i++) {
        ...
        if (timeNow == this.year) {
          ...
          for (var i = 0; i < num1.length; i++) {
            this.data1[i] = {
              name: num1[i].城市,
              value: num1[i].数值.substring(0, 4)
            };
            this.data2[i] = {
              name: num2[i].城市,
              value: num2[i].数值.substring(0, 4)
            };
            this.data3[i] = {
              name: num3[i].城市,
              value: num3[i].数值.substring(0, 5)
            };
            this.isFirst = false;
          }
        }
  ...
  methods: {
    getData() {
      this.content = financialMapObj.content
      var value = financialMapObj.content
