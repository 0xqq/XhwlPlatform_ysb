...
import customMapObj from'@/httpData/customMap.js';
...
export default {
    ...
    year: function() {
      for (var i = 0; i < this.content.length; i++) {
        ...
        if (timeNow == this.year) {
          var num1 = this.content[i].停车场月卡缴费率前十;
          var num2 = this.content[i].客户满意度前十;
          var num3 = this.content[i].投诉统计前十;
          var num4 = this.content[i].投诉销项率前十;
  ...
  methods: {
    getData() {
      this.content= customMapObj.content
      var value = customMapObj.content
      for (var i = 0; i < value.length; i++) {
        ...
        var timeNow = year + '-' + month;
        if (timeNow == this.year) {
          var num1 = value[i].停车场月卡缴费率前十;
          var num2 = value[i].客户满意度前十;
          var num3 = value[i].投诉统计前十;
          var num4 = value[i].投诉销项率前十;
          for (var i = 0; i < num1.length; i++) {
            this.data1[i] = {
              name: num1[i].城市,
              value: num1[i].数值
    ...
    drawLine() {
      ...
      var option = {
        ...
        color: ['#00BFFF', '#FF4500', '#87CEFA', '#90EE90'],
        tooltip: {
          trigger: 'item',
